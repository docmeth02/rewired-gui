...
class interface():
    ...
    def build(self):
        ...
        dnslabel = ttk.Label(self.innerFrame, text="advertised DNS: \n (optional)")
        dnslabel.grid(row=2, column=0, sticky=tk.E, pady=5)
        self.trackerdns = tk.Entry(self.innerFrame, width=30)
        self.trackerdns.insert(0, "")
        self.trackerdns.grid(row=2, column=1, columnspan=2, sticky=tk.W, pady=5)

        bandwidthlabel = ttk.Label(self.innerFrame, text="Bandwidth: ")
        bandwidthlabel.grid(row=3, column=0, sticky=tk.E, pady=5)
    ...
    def saveConf(self):
        ...
        self.parent.config['trackerDNS'] = self.trackerdns.get()
